...
with open('human_conv.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
n = int(0.9*len(data)) # first 90% will be train and rest will be val
train_data = data[:n]
val_data = data[n:]
...
torch.save(m.state_dict(), 'model_human_conv.pth')
